...
export async function GET() {
  try {
    ...
    const url = `${jellyfinUrl}/Users/${auth.userId}/Items?IncludeItemTypes=Movie,Series&SortBy=SortName&Recursive=true&Fields=PrimaryImageAspectRatio,Overview,Path,CommunityRating,RunTimeTicks,OfficialRating,ProductionYear`;
    ...
    console.log('[GET_ALL_MEDIA] Fetched', jellyfinData.Items?.length || 0, 'items from Jellyfin');
    ...
    console.log('[GET_ALL_MEDIA] Success. Media count:', items.length);
