        ...
        <div className="relative max-h-[90vh] overflow-y-auto">
          ...
          <div className="relative h-80 overflow-hidden">
            ...
            <div className="absolute bottom-6 left-6 right-6">
              ...
              {/* Play Button */}
              <Button className="bg-white text-black hover:bg-white/90 font-semibold px-8 py-2 rounded text-lg">
                <div className="mr-2">
                      ...
                      <AccordionContent className="px-4 pb-4">
                        <div className="space-y-3">
                          {episodes[season.Id]?.map((episode, index) => (
                            <div key={episode.Id} className="flex space-x-4 p-3 bg-zinc-800/30 rounded-lg hover:bg-zinc-800/50 transition-colors cursor-pointer">
